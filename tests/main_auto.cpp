...
int main() {
  ...
  //   AS_INFOMSG(1, "Print: Orig: %d Dest: %d Size: %zu O_Offs: %zu D_Offs: %zu, Path No.: %d", a_dep->orig, a_dep->dest, a_dep->size, a_dep->of_s, a_dep->of_d, a_dep->ipth);
