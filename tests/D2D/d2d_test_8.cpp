...
//**************************************************//
  ...
  // Allocate device memory
  x_ptr[4] = omp_target_alloc(size_c, 4);
...
// PROG=d2d_test_8; clang++ -fopenmp -fopenmp-targets=nvptx64 -o $PROG.x --cuda-gpu-arch=sm_70 -L/soft/compilers/cuda/cuda-11.0.2/lib64 -L/soft/compilers/cuda/cuda-11.0.2/targets/x86_64-linux/lib/ -I/soft/compilers/cuda/cuda-11.0.2/include -ldl -lcudart -pthread $PROG.cpp

//**************************************************//
//                        RUN                       //
//**************************************************//

// OMP_PROC_BIND=spread taskset -c 0,1,20 ./d2d_test_8.x

// nsys profile -o d2d_test_8_6G_v2 ./run_one.sh

// nsys profile -o d2d_test_8_6G ./d2d_test_8.x
// taskset -c 0,1,20 ./d2d_test_8.x

// OMP_PROC_BIND=true OMP_DYNAMIC=true OMP_MAX_ACTIVE_LEVELS=2 OMP_DISPLAY_ENV=VERBOSE

// ./d2d_test_8.x 
// ./d2d_test_8.x>out_test.o  2>&1
// nsys profile -o test_prof --stats=true ./d2d_test_8.x
// nsys profile -o d2d_test_8_6G_0 ./d2d_test_8.x

// OMP_PROC_BIND=true nsys profile -o d2d_test_8_6G_1 ./d2d_test_8.x
// OMP_DYNAMIC=true nsys profile -o d2d_test_8_6G_2 ./d2d_test_8.x
// OMP_MAX_ACTIVE_LEVELS=2 nsys profile -o d2d_test_8_6G_3 ./d2d_test_8.x
// OMP_PROC_BIND=true OMP_DYNAMIC=true nsys profile -o d2d_test_8_6G_4 ./d2d_test_8.x
// OMP_PROC_BIND=true OMP_DYNAMIC=true OMP_MAX_ACTIVE_LEVELS=2 nsys profile -o d2d_test_8_6G_5 ./d2d_test_8.x
// OMP_PROC_BIND=spread,close OMP_DYNAMIC=true nsys profile -o d2d_test_8_6G_5 ./d2d_test_8.x
